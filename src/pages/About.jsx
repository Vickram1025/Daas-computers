...
const About = () => {
  return (
    <div className="bg-blue-100 min-h-screen py-12 px-4 sm:px-6 md:px-10 lg:px-16">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <section className="space-y-8">
          <h2 className="text-xl sm:text-3xl font-semibold text-center text-gray-800">
            Our Mission & Vision
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div
              {...fadeLeft}
              className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-4">
                <Flag className="w-7 h-7 sm:w-8 sm:h-8 text-blue-500" />
                <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Our Mission</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-4">
                <Eye className="w-7 h-7 sm:w-8 sm:h-8 text-blue-500" />
                <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Our Vision</h3>
              </div>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
        ...
        <section className="space-y-8">
          <h2 className="text-xl sm:text-3xl font-semibold text-center text-gray-800">
            Why Choose Dass Computer Store?
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="flex items-start gap-4 bg-white rounded-2xl p-5 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                <Icon className="text-blue-500 w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0" />
                <div>
        ...
        <motion.section
          {...fadeLeft}
          className="text-center space-y-4 px-2 sm:px-8"
        >
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
            Thank you for choosing <span className="font-semibold text-blue-600">Dass Computer Store</span>.
            We're here to help you find the perfect laptop with confidence and ease.
          </p>
